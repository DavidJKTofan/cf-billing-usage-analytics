/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ae5e5d10d16f5835d62d80504ce91550)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		USAGE_MONITOR_WORKFLOW: Workflow<Parameters<import("./src/index").UsageMonitorWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_TOKEN_ANALYTICS_READ_ONLY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ZONE_ID" | "DISCORD_WEBHOOK_URL">> {}
}
